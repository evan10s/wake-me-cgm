...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    override fun isValidFragment(fragmentName: String): Boolean {
        return PreferenceFragment::class.java.name == fragmentName
                ...
                || AlertPreferenceFragment::class.java.name == fragmentName
    }
    ...
    class AlertPreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            fbPrefEditor.commit()
            Log.d("WAKEMECGM",fbPrefManager.getString("firebase_token",""))
            super.onCreate(savedInstanceState)
            ...
            // guidelines.
            //bindPreferenceSummaryToValue(findPreference("sync_frequency"))
            bindPreferenceSummaryToValue(findPreference("low_threshold"))
            bindPreferenceSummaryToValue(findPreference("high_threshold"))
            bindPreferenceSummaryToValue(findPreference("firebase_token"))
